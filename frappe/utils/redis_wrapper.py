...
class ClientCache:
    ...
    def get_doc(self, doctype: str, id: str | None = None):
        ...
        if not id:
            id = doctype  # singles
        key = frappe.get_document_cache_key(doctype, id)
        return self.get_value(key, generator=lambda: frappe.get_doc(doctype, id))
