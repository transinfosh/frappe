...
jinja = {
	...
	"filters": [
		...
		"frappe.utils.get_barcode.get_barcode",
...
sounds = [
	{"id": "email", "src": "/assets/frappe/sounds/email.mp3", "volume": 0.1},
	{"id": "submit", "src": "/assets/frappe/sounds/submit.mp3", "volume": 0.1},
	{"id": "cancel", "src": "/assets/frappe/sounds/cancel.mp3", "volume": 0.1},
	{"id": "delete", "src": "/assets/frappe/sounds/delete.mp3", "volume": 0.05},
	{"id": "click", "src": "/assets/frappe/sounds/click.mp3", "volume": 0.05},
	{"id": "error", "src": "/assets/frappe/sounds/error.mp3", "volume": 0.1},
	{"id": "alert", "src": "/assets/frappe/sounds/alert.mp3", "volume": 0.2},
	# {"id": "chime", "src": "/assets/frappe/sounds/chime.mp3"},
]
