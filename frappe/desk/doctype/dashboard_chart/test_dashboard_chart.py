...
class TestDashboardChart(IntegrationTestCase):
    ...
    def test_dashboard_chart(self):
        ...
        result = get(chart_id="Test Dashboard Chart", refresh=1)
    ...
    def test_empty_dashboard_chart(self):
        ...
        frappe.get_doc(
            doctype="Dashboard Chart",
            chart_id="Test Empty Dashboard Chart",
            chart_type="Count",
        ...
        result = get(chart_id="Test Empty Dashboard Chart", refresh=1)
    ...
    def test_chart_wih_one_value(self):
        ...
        frappe.get_doc(
            doctype="Dashboard Chart",
            chart_id="Test Empty Dashboard Chart 2",
            chart_type="Count",
            document_type="Error Log",
            based_on="creation",
            timespan="Last Year",
        ...
        result = get(chart_id="Test Empty Dashboard Chart 2", refresh=1)
    ...
    def test_group_by_chart_type(self):
        ...
        frappe.get_doc(
            doctype="Dashboard Chart",
            chart_id="Test Group By Dashboard Chart",
            chart_type="Group By",
            document_type="ToDo",
        ...
        result = get(chart_id="Test Group By Dashboard Chart", refresh=1)
    ...
    def test_daily_dashboard_chart(self):
        insert_test_records(self.doctype_id)
        ...
        frappe.get_doc(
            doctype="Dashboard Chart",
            chart_id="Test Daily Dashboard Chart",
            chart_type="Sum",
            document_type=self.doctype_id,
            based_on="date",
        ...
        result = get(chart_id="Test Daily Dashboard Chart", refresh=1)
    ...
    def test_weekly_dashboard_chart(self):
        ...
        frappe.get_doc(
            doctype="Dashboard Chart",
            chart_id="Test Weekly Dashboard Chart",
            chart_type="Sum",
            document_type=self.doctype_id,
            based_on="date",
            value_based_on="number",
        ...
        with patch.object(frappe.utils.data, "get_first_day_of_the_week", return_value="Monday"):
            result = get(chart_id="Test Weekly Dashboard Chart", refresh=1)
    ...
    def test_avg_dashboard_chart(self):
        ...
        frappe.get_doc(
            doctype="Dashboard Chart",
            chart_id="Test Average Dashboard Chart",
            chart_type="Average",
            document_type=self.doctype_id,
            based_on="date",
            value_based_on="number",
        ...
        with patch.object(frappe.utils.data, "get_first_day_of_the_week", return_value="Monday"):
            result = get(chart_id="Test Average Dashboard Chart", refresh=1)
            self.assertEqual(result.get("labels"), ["12-30-2018", "01-06-2019", "01-13-2019", "01-20-2019"])
    ...
    def test_user_date_label_dashboard_chart(self):
        ...
        frappe.get_doc(
            doctype="Dashboard Chart",
            chart_id="Test Dashboard Chart Date Label",
            chart_type="Count",
            document_type="DocType",
            based_on="creation",
            timespan="Select Date Range",
        ...
        with patch.object(frappe.utils.data, "get_user_date_format", return_value="dd.mm.yyyy"):
            result = get(chart_id="Test Dashboard Chart Date Label")
...
def insert_test_records(doctype_id):
    create_new_record(doctype_id, "Title 1", datetime(2018, 12, 30), 50)
    create_new_record(doctype_id, "Title 2", datetime(2019, 1, 4), 100)
    create_new_record(doctype_id, "Title 3", datetime(2019, 1, 6), 200)
    create_new_record(doctype_id, "Title 4", datetime(2019, 1, 7), 400)
    create_new_record(doctype_id, "Title 5", datetime(2019, 1, 8), 300)
    create_new_record(doctype_id, "Title 6", datetime(2019, 1, 10), 100)


def create_new_record(doctype_id, title, date, number):
    doc = {
        "doctype": doctype_id,
        "title": title,
        "date": date,
    ...
    if not frappe.db.exists(doctype_id, {"title": doc.title}):
