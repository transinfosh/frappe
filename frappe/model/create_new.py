...
def get_default_based_on_another_field(df, user_permissions, parent_doc):
    ...
    reference_id = parent_doc.get(ref_fieldname) if parent_doc else frappe.db.get_default(ref_fieldname)
    default_value = frappe.db.get_value(ref_doctype, reference_id, df.fieldname)
