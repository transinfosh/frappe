...
def delete_doc(doctype: str, id: str):
    frappe.client.delete_doc(doctype, id)
...
url_rules = [
    ...
    Rule("/document/<doctype>/<path:id>/", methods=["GET"], endpoint=read_doc),
    Rule("/document/<doctype>/<path:id>/copy", methods=["GET"], endpoint=copy_doc),
    Rule("/document/<doctype>/<path:id>/", methods=["PATCH", "PUT"], endpoint=update_doc),
    Rule("/document/<doctype>/<path:id>/", methods=["DELETE"], endpoint=delete_doc),
    Rule(
        "/document/<doctype>/<path:id>/method/<method>/",
        methods=["GET", "POST"],
