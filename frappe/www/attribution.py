...
def get_app_info(app: str):
    ...
    for requirement in app_info.get("dependencies", []):
        ...
        metadata = get_python_package_metadata(id)
...
def get_js_deps(app: str) -> list[dict]:
    ...
    for id in packages:
        ...
        package_info = {"id": id, "type": "JavaScript", "license": "Unknown", "author": "Unknown"}

        # Try to find package.json in node_modules
        package_json_path = node_modules_path / id / "package.json"
