...
class TestReport(IntegrationTestCase):
    ...
    def test_save_or_delete_report(self):
        ...
        try:
            ...
            self.assertRaises(frappe.PermissionError, delete_report, report.id)
    ...
    def test_custom_report(self):
        ...
        admin_dict = frappe.core.utils.find(result, lambda d: d["id"] == "Administrator")
...
totals = {}
for user in frappe.get_all('User', fields = ['id', 'user_type', 'creation']):
