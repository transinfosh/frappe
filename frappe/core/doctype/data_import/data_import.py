...
@frappe.whitelist()
def download_errored_template(data_import_id: str):
    data_import: DataImport = frappe.get_doc("Data Import", data_import_id)
    data_import.check_permission("read")
    data_import.export_errored_rows()


@frappe.whitelist()
def download_import_log(data_import_id: str):
    data_import: DataImport = frappe.get_doc("Data Import", data_import_id)
    data_import.check_permission("read")
...
@frappe.whitelist()
def get_import_status(data_import_id: str):
    data_import: DataImport = frappe.get_doc("Data Import", data_import_id)
    data_import.check_permission("read")
...
def get_import_logs(data_import: str):
    ...
    return frappe.get_all(
        "Data Import Log",
        fields=["success", "docid", "messages", "exception", "row_indexes"],
