...
class TestSimpleFile(IntegrationTestCase):
    def setUp(self):
        self.attached_to_doctype, self.attached_to_docid = make_test_doc()
...
class TestSameContent(IntegrationTestCase):
    def setUp(self):
        self.attached_to_doctype1, self.attached_to_docid1 = make_test_doc()
        self.attached_to_doctype2, self.attached_to_docid2 = make_test_doc()
        self.test_content1 = test_content1
...
class TestFile(IntegrationTestCase):
    ...
    def test_same_file_url_update(self):
        attached_to_doctype1, attached_to_docid1 = make_test_doc()
        attached_to_doctype2, attached_to_docid2 = make_test_doc()
...
class TestGuestFileAndAttachments(IntegrationTestCase):
    ...
    def test_list_private_guest_attachment(self):
        ...
        self.attached_to_doctype, self.attached_to_docid = make_test_doc(ignore_permissions=True)
